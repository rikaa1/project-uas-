...
public class JFramereportclinicdokter extends javax.swing.JFrame {
     ...
     */
    public JFramereportclinicdokter() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramereportclinicdokter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFramereportclinicdokter().setVisible(true);
            }
        });
    }
