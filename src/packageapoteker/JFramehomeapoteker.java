...
public class JFramehomeapoteker extends javax.swing.JFrame {
...
//        SubmenuData.setVisible(!SubmenuData.isVisible());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramehomeapoteker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFramehomeapoteker().setVisible(true);
            }
        });
    }
